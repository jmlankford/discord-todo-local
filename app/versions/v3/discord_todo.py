...
class DiscordTodoApp:
    def __init__(self):
        ...
        self._all_var      = None   # "select all" header var
    ...
    def run_widget(self):
        ...
        self._complete_btn = tk.Button(
            ...
            font=('Segoe UI', 8, 'bold'), bg=bbar_bg, fg='#005500',
            relief='flat', bd=0, cursor='hand2',
            activebackground=darken(bbar_bg), activeforeground='#003300')
        self._complete_btn.pack(side='right', padx=(0, 8), pady=4)
    ...
    def _apply_colors(self):
        ...
        if self._complete_btn:
            self._complete_btn.configure(bg=bbar_bg, activebackground=darken(bbar_bg))
        if self._grip:
    ...
    def _draw_tasks(self):
        ...
        if not self.tasks:
            ...
            tk.Checkbutton(
                hdr, text="Completed?", variable=self._all_var, command=toggle_all,
                font=('Segoe UI', 8, 'bold'), bg=bg, fg=fg,
                selectcolor=darken(bg, 0.88), activebackground=bg,
